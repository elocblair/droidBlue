package com.example.neuronifier.bletest;
...
public class MainActivity extends AppCompatActivity
{
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status)
        {
            ...
            if( gatt == mBluetoothGatt){
                if(status == BluetoothGatt.GATT_SUCCESS){
                    ...
                    int val = MSB|LSB;
                    float gyroX = val/16.0f;
                    MSB = temp[3] << 8;
                    LSB = temp[2]&0x000000FF;
                    val = MSB|LSB;
                    float gyroY = val/16.0f;
                    MSB = temp[5] << 8;
                    LSB = temp[4]&0x000000FF;
                    val = MSB|LSB;
                    float gyroZ = val/16.0f;
                    ...
                    Log.v("Sensor Values", " "  + gyroX + ", " + gyroY + ", " + gyroZ);
    ...
    public void updateTextView(String toThis){
        TextView valueEntry = (TextView) findViewById(R.id.valueEntry);
        valueEntry.setText(toThis);
    }
